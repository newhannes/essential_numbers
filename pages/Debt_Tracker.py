...
st.markdown(f"<h3 style='text-align: center; color: black;'> As of {today}.</h3>", unsafe_allow_html=True)
...
with st.columns(1)[0]:
        ...
        with cols1[0]:
                ...
                st.markdown(f"- **\${debt_per_household:,}** per household")
                st.markdown(f"- **\${debt_per_child:,}** per child")
...
with row2[0]:
        ...
        with cols2[0]:       
                ...
                st.markdown(f"- **${biden_debt_per_person:,}** more debt per person")
                st.markdown(f"- **${biden_debt_per_household:,}** more debt per household")
                st.markdown(f"- **${biden_debt_per_child:,}** more debt per child")
                
                st.write("The rate of debt accumulation during the Biden Administration has equaled:")
                st.markdown(f"- **${biden_debt_per_day_rounded:,} billion** in new debt per day")
                st.markdown(f"- **${biden_debt_per_hour:,} million** in new debt per hour")
...
with row3[0]:
        ...
        with cols3[0]:
                ...
                st.markdown(f"- **${last_year_debt_per_day_rounded:,} billion** in new debt per day")
                st.markdown(f"- **${last_year_debt_per_hour:,} million** in new debt per hour")
                st.markdown(f"- **${last_year_debt_per_min:,} million** in new debt per minute")
                st.markdown(f"- **${last_year_debt_per_sec:,}** in new debt per second")
        #with cols3[1]:
